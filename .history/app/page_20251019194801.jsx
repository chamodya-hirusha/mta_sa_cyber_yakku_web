...
export default function CyberYakkuShop() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col  xs:pt-20 md:pt-10 xl:pt-10">
        {/* Animated background gradient */}
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-xs:container py-3 tablet:py-4 desktop:py-5  h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
        ...
        <main className="relative flex-1 overflow-y-auto">
          {activeTab === 'Home' ? (
            <>
              ...
              <div className="px-0 sm:px-4 md:px-6 lg:px-6 xl:px-auto py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12">
                <HeroSection1 />
              </div>
