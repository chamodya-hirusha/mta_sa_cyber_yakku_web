...
export default function CyberYakkuShop() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex">
      ...
      {/* Main Content */}
      <div className="container py-3 tablet:py-4 desktop:py-5 mx-auto flex-1 flex flex-col">
        ...
        {/* Content */}
        <main className="relative flex-1 pt-20 overflow-y-auto">
          {activeTab === 'Home' ? (
            <>
              {/* Hero Section 1 - Featured Game */}
              <div className="px-0 sm:px-4 md:px-6 lg:px-6 xl:px-6 py-4 sm:py-6 md:py-6 lg:py-10 xl:py-12">
                <HeroSection1 />
              </div>
