...
export default function HeroSection1() {
  return (
    <div className="w-full xs:pt-40 group bg-gradient-to-br rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 cursor-pointer relative overflow-hidden touch-manipulation [-webkit-tap-highlight-color:transparent]">
      ...
      style={{ WebkitOverflowScrolling: 'touch' }}>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-0 min-h-0">
          ...
          space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 order-2 md:order-1 lg:order-1 z-10 min-h-0">
