...
export default function HeroSection2() {
  return (
    <div className="w-full group bg-gradient-to-br from-slate-900/50 to-purple-900/20  rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-red-500/10 cursor-pointer relative overflow-hidden touch-manipulation [-webkit-tap-highlight-color:transparent]">
      <div className="relative bg-gradient-to-br from-red-950/40 via-purple-950/30 to-slate-900 rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden border border-red-500/30 shadow-2xl hover:shadow-red-500/20 transition-all duration-500 backdrop-blur-sm">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-0">
          ...
          {/* Right Panel - Image */}
          <div className="relative h-64 sm:h-72 md:h-80 lg:h-auto min-h-[400px] md:min-h-[450px] lg:min-h-[500px] order-1 md:order-2 lg:order-2">
