...
export default function ProfileDropdown({ isOpen, onClose, onLogout, router, onMouseEnter, onMouseLeave }) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-0 mt-2 w-48 bg-slate-900 border border-purple-500/30 rounded-lg shadow-xl shadow-purple-500/20 overflow-hidden z-50"
