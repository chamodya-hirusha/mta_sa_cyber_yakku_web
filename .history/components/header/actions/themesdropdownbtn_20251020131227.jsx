...
export default function ThemeDropdown() {
  ...
  const themes = [
    { id: "default", icon: <FaPalette />, label: "Default ", class: "default" },
    { id: "dark", icon: <FaMoon />, label: "Dark ", class: "dark" },
    { id: "light", icon: <FaSun />, label: "Light ", class: "light" },
    { id: "ocean", icon: <FaWater />, label: "Ocean ", class: "ocean" },
    { id: "sunset", icon: <FaCloudSun />, label: "Sunset ", class: "sunset" },
    { id: "forest", icon: <FaTree />, label: "Forest ", class: "forest" },
    { id: "candy", icon: <FaCandyCane />, label: "Candy ", class: "candy" },
  ];
