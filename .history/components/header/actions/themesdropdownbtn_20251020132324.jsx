...
import { FaPalette, FaMoon, FaSun, FaWater, FaCloudSun, FaTree, FaCandyCane } from 'react-icons/fa';
...
export default function ThemeDropdown() {
  ...
  const themes = [
    { id: "default", icon: <FaPalette />, label: "Default ", class: "theme-default" },
    { id: "dark", icon: <FaMoon />, label: "Dark ", class: "dark-theme" },
    { id: "light", icon: <FaSun />, label: "Light ", class: "light-theme" },
    { id: "ocean", icon: <FaWater />, label: "Ocean ", class: "theme-ocean" },
    { id: "sunset", icon: <FaCloudSun />, label: "Sunset ", class: "theme-sunset" },
    { id: "forest", icon: <FaTree />, label: "Forest ", class: "theme-forest" },
    { id: "candy", icon: <FaCandyCane />, label: "Candy ", class: "theme-candy" },
  ];
