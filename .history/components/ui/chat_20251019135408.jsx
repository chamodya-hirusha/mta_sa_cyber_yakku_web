{/* Cart Sidebar */}
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
        ...
        <a
          ...
          className="group relative w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group w-14 h-14 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110"
