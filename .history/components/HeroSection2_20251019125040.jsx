...
export default function HeroSection2() {
  return (// Added a wrapper for horizontal scrolling on mobile
    <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8 overflow-x-auto md:overflow-x-visible">
