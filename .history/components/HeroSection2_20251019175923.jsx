...
export default function HeroSection2() {
  return (
    <div className="w-full px-3 sm:px-4 md:px-6 xl:px-6 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12">
      <div className="relative bg-gradient-to-br from-red-950/40 via-purple-950/30 to-slate-900 rounded-xl sm:rounded-2xl md:rounded-8 py-4 sm:py-6 md:py-8">
